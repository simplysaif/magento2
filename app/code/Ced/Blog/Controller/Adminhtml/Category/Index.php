...
class Index extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if($helper==1) {
            ...
            $resultPage->addBreadcrumb(__('Add Attribute'), __('Manage Blog Category'));
            $resultPage->getConfig()->getTitle()->prepend(__('Manage Blog Category'));
            return $resultPage;
        } else {
    ...
    protected function _isAllowed()
    {
        ...
        return $this->_authorization->isAllowed('Ced_Blog::category');
