<?php 
 ...
 class BlogPost extends \Magento\Backend\Block\Widget\Container
 {
    /**
     * @var string
     */
    ...
    */
    ...
    protected function _prepareLayout()
    {
        $this->setChild(
            'grid',
            $this->getLayout()->createBlock('Ced\Blog\Block\Adminhtml\BlogPost\Edit\Tab\ProductGrid\Grid', 'grid.view.grid')
            );
