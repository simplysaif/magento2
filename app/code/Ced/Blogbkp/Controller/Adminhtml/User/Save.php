    ...
    public function execute()
    {
        ...
        */
        ...
        try {
            ...
            $collection = $this->_objectManager->create('Ced\Blog\Model\User'); 
            if($_FILES['profile']['name'] !="") {
                ...
                $collection->setData('profile', $fileName);
            } else {
                $user_model = $collection->load($model->getId());
                $img = $user_model['profile'];
                $collection->setData('profile', $img);
            }
            $collection->setData('user_id', $model->getId())
