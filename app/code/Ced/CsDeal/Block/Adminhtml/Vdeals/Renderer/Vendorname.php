...
class Vendorname extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer {
	...
	public function render(\Magento\Framework\DataObject $row) {
		 return $this->_objectManager->get('Ced\CsMarketplace\Model\Vendor')->load($row->getData($this->getColumn()->getIndex()))->getName().' ('.$this->_objectManager->get('Ced\CsMarketplace\Model\Vendor')->load($row->getData($this->getColumn()->getIndex()))->getEmail().')';
	}
}