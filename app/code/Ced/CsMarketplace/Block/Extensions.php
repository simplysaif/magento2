...
class Extensions extends \Magento\Config\Block\System\Config\Form\Fieldset
{
    ...
    public function render(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $modules = $this->_objectManager->get('\Ced\CsMarketplace\Helper\Feed')->getAllModules();
    ...
    {
        $hash = \Ced\CsMarketplace\Block\Extensions::HASH_PATH_PREFIX . strtolower($moduleName) . '_hash';
        $level = \Ced\CsMarketplace\Block\Extensions::HASH_PATH_PREFIX . strtolower($moduleName) . '_level';
        ...
        $l = $this->_objectManager->create('\Ced\CsMarketplace\Helper\Feed')->getLicenseFromHash($hash, $level);
