    ...
    protected function getSuccessMessage()
    {
        ...
        if ($this->addressHelper->isVatValidationEnabled()) {
            if ($this->addressHelper->getTaxCalculationAddressType() == Address::TYPE_SHIPPING) {
                ...
                $message['html'] = 'If you are a registered VAT customer, please click <a href="%1">here</a> to enter your shipping address for proper VAT calculation.';
                // @codingStandardsIgnoreEnd
            } else {
                // @codingStandardsIgnoreStart
                $message['html'] = 'If you are a registered VAT customer, please click <a href="%1">here</a> to enter your billing address for proper VAT calculation.';
                // @codingStandardsIgnoreEnd
            }
            $message['params'] = $this->urlModel->getUrl('customer/address/edit');
        } else {
            $message['html'] = 'Thank you for registering with %1.';
            $message['params'] = $this->storeManager->getStore()->getFrontendName();
        }
        return $message;
    }
