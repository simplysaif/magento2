...
class Feed extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function __construct(\Magento\Framework\App\Helper\Context $context ,
        ...
        $this->_allowedFeedType =  explode(',', $backendConfig->getValue(\Ced\CsMarketplace\Model\Feed::XML_FEED_TYPES));
    ...
    {
        $modulePaths = $this->_objectManager->get('Magento\Framework\Component\ComponentRegistrar')
    ...
    public function getEnvironmentInformation() 
    {
        ...
        $info['feed_types'] = $this->_backendConfig->getValue(\Ced\CsMarketplace\Model\Feed::XML_FEED_TYPES);
