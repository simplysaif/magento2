...
(function(factory) {
    ...
    $.fn.fullCalendar = function(options) {
        ...
        this.each(
            function(i, _element) { // loop each DOM element involved
    ...
    fc.datepickerLang = function(langCode, dpLangCode, dpOptions) {
        ...
        $.each(
            dpComputableOptions, function(name, func) {
    ...
    fc.lang = function(langCode, newFcOptions) {
        ...
        $.each(
            momComputableOptions, function(name, func) {
    ...
    */
    ...
    Grid.mixin(
        {
            ...
            bindSegHandlers: function() {
                ...
                $.each(
                    ...
                    function(name, func) {
                        ...
                        _this.el.on(
                            name, '.fc-event-container > *', function(ev) {
            ...
            eventsToRanges: function(events) {
                ...
                $.each(
                    eventsById, function(id, eventGroup) {
    ...
    function Calendar(element, instanceOptions) {
        ...
        function _calcSize() { // assumes elementVisible
            if (typeof options.contentHeight === 'number') { // exists and not 'auto'
                ...
                suggestedViewHeight = Math.round(
                    content.width() / Math.max(options.aspectRatio, .5));
            }
                    }
        ...
        function renderSection(position) {
                    ...
                    if (buttonStr) {
                $.each(
                buttonStr.split(' '), function(i) {
                        var groupChildren = $();
                        var isOnlyButtons = true;
                        var groupEl;

                        $.each(
                        this.split(','), function(j, buttonName) {
                            var buttonClick;
                            var themeIcon;
                            var normalIcon;
                            var defaultText;
                                ...
                                if (buttonClick) {
                                    ...
                                    function() {
                                     ...
                                     if (!button.hasClass(tm + '-state-disabled')) {
                                      ...
                                      if (button.hasClass(tm + '-state-active') 
                    ...
                    function buildEventSource(sourceInput) { // will return undefined if invalid source
                        ...
                        if (source) {
                            ...
                            if ($.isArray(source.events)) {
                                ...
                                source.events = $.map(
                                    source.events, function(eventInput) {
