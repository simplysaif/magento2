...
class Grid extends \Magento\Eav\Block\Adminhtml\Attribute\Grid\AbstractGrid{
    ...
    protected function _prepareCollection(){
		...
		$collection = $this->_objectManager->create('Magento\Eav\Model\Entity\Attribute')->getCollection();
		
		$typeId = $this->_objectManager->create('Ced\CsMarketplace\Model\Vendor')->getEntityTypeId();
		...
		$collection->getSelect()->joinLeft(array('vform'=>$tableName), 'main_table.attribute_id = vform.attribute_id && vform.store_id ='.$this->getStoreId(), array('is_visible'=> 'vform.is_visible', 'use_in_registration'=>'vform.use_in_registration', 'use_in_left_profile'=>'vform.use_in_left_profile','use_in_invoice'=> 'vform.use_in_invoice','registration_step_no'=>'vform.registration_step_no'));
