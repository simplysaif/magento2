...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
     ...
     * @param \Ced\CsMarketplace\Model\Vproducts $_objectManager
     * @param array $data
     */
    public function __construct(
        ...
        \Ced\CsMarketplace\Model\Vproducts $_objectManager,
        array $data = []
    )
    {
    ...
    protected function _prepareCollection()
    {
        ...
        $curProduct = $this->_objectManager->getVendorProductIds();
