...
class File extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     * @return array
     */
    public function uploadFromTmp($tmpPath, \Magento\MediaStorage\Model\File\Uploader $uploader,$allowedExtension)
    {
        $uploader->setAllowRenameFiles(true);
        $uploader->setAllowedExtensions($allowedExtension);
