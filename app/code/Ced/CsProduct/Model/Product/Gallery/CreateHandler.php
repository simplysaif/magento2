 ...
 */
namespace Ced\CsProduct\Model\Product\Gallery;
...
class CreateHandler extends \Magento\Catalog\Model\Product\Gallery\CreateHandler
{
    ...
    public function execute($product, $arguments = [])
    {
        ...
        foreach( $value['images'] as $images) {
        	if (is_array($images['file'])) {
        		$images['file'][0]['disabled'] = $images['disabled'];
        		$images['file'][0]['label'] = $images['label'];
        		$value['images'] = $images['file'];
        	}
        }
