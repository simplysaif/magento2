...
class CustomOptions extends \Magento\Catalog\Ui\DataProvider\Product\Form\Modifier\CustomOptions
{
    ...
    public function modifyMeta(array $meta)
    {
        ...
        if($this->scopeConfig->getValue('ced_csmarketplace/vproducts/customoptions', \Magento\Store\Model\ScopeInterface::SCOPE_STORE))
        {	
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'componentType' => DynamicRows::NAME,
                        'component' => 'Ced_CsProduct/js/dynamic-rows/dynamic-rows',
                        'additionalClasses' => 'admin__field-wide',
                        'deleteProperty' => static::FIELD_IS_DELETE,
                        'deleteValue' => '1',
                        'renderDefaultRecord' => false,
