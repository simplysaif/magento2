 ...
 */
class Samples extends \Magento\Downloadable\Ui\DataProvider\Product\Form\Modifier\Samples
{
    /**
    ...
    public function __construct(
    	...
    	parent::__construct($locator, $storeManager, $arrayManager, $urlBuilder, $typeUpload, $samplesData);
    ...
    protected function getSampleColumn()
    {
        ...
        $sampleUploader['arguments']['data']['config'] = [
            ...
            'component' => 'Ced_CsProduct/js/components/file-uploader2',
            'elementTmpl' => 'Ced_CsProduct/components/file-uploader2',
