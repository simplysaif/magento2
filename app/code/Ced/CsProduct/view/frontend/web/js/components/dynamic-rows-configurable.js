...
define([
    'underscore',
    'uiRegistry',
    'Ced_CsProduct/js/dynamic-rows/dynamic-rows'
    ...
    return dynamicRows.extend({
        ...
        processingUnionInsertData: function (data) {
            ...
            if (dataCount > elemsCount) {
            	if(typeof this.getChildItems().each=='function'){
            	...
            	else
            	{
	            	var self= this;
	            	var startIndex = 0;
	            	jQuery.each(this.getChildItems(), function (index, elemData) {
	            		self.addChild(elemData, startIndex + index);
	                });
            	}
            } else {
