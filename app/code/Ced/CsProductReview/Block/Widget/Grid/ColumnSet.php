 ...
 */
namespace Ced\CsProductReview\Block\Widget\Grid;
...
class ColumnSet extends \Magento\Framework\View\Element\Template
{
    ...
    {
    	$urlModel = \Magento\Framework\App\ObjectManager::getInstance()->create('\Magento\Framework\UrlInterface');
    	$url = $urlModel->getUrl('productreview/rating/edit',array('id'=>$item->getRatingId()));
    	return $url;
