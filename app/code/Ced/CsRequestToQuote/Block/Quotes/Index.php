...
class Index extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {      
        ...
        $vendor = $this->_objectManager->get('Ced\CsMarketplace\Model\Vendor')->load($this->_session->getVendorId());

        $collection = $this->_objectManager->create('Ced\RequestToQuote\Model\Quote')->getCollection()->addFieldToFilter('vendor_id', $this->_session->getVendorId());
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'type' => 'options',
                'index' => 'status',
                'options' => $this->_quote->getStatusArray(),
                'header_css_class' => 'col-id',
                'column_css_class' => 'col-id',
                'renderer' => 'Ced\CsRequestToQuote\Block\Quotes\Renderer\Quotestatus'
        ...
        $this->addColumn(
            'quote_total_price',
            [
                'header' => __('Quote Price'),
                'type' => 'currency',
                'index' => 'quote_total_price',
                'header_css_class' => 'col-id',
                'column_css_class' => 'col-id'
            ]
        );
        ...
        $this->addColumn(
            'quote_total_qty',
            [
                'header' => __('Quote Requested Qty'),
                'type' => 'text',
                'index' => 'quote_total_qty',
                'header_css_class' => 'col-id',
                'column_css_class' => 'col-id'
            ]
        );
        ...
        $this->addColumn(
            'quote_updated_qty',
            [
                'header' => __('Quote Updated Qty'),
                'type' => 'text',
                'index' => 'quote_updated_qty',
                'header_css_class' => 'col-id',
                'column_css_class' => 'col-id'
            ]
        );
        ...
        $this->addColumn(
            'shipping_amount',
            [
                'header' => __('Quote Shipping Amount'),
                'type' => 'currency',
        ...
        $this->addColumn(
            'quote_updated_price',
            [
                'header' => __('Quote Updated Price'),
                'type' => 'currency',
                'index' => 'quote_updated_price',
                'header_css_class' => 'col-id',
                'column_css_class' => 'col-id',
