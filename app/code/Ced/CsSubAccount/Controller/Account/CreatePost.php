...
class CreatePost extends \Magento\Framework\App\Action\Action
{
   ...
   protected function extractAddress()
    ...
    public function execute()
    {
        ...
        try {
            $subVendor = $this->_objectManager->create('Ced\CsSubAccount\Model\CsSubAccount')->load($this->getRequest()->getPost('email'),'email')->getData();
            if(count($subVendor)){
                $this->messageManager->addError('Customer with this Email already exist');
