...
{	
  ...
  protected $_resourceCollection;
	...
	protected function _prepareForm()
    {
			...
			//$base_amount=$base_amount+$totalShippingAmount;
 ...
 $htmlIdPrefix = $form->getHtmlIdPrefix();
    ...
    public function getAmountDescriptionHtml()
    {
    	...
    	$orderArray = array();
	 	...
	 	$order_enable = $objectManager->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('ced_vorders/general/vorders_active');
		$orderArray['service_tax'] = $objectManager->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('ced_vpayments/general/service_tax');
	 	...
	 	foreach($orderIds as $id=>$amount)
	 	{
	 		...
	 		$order = $objectManager->get('Ced\CsMarketplace\Model\Vorders')->getCollection()->addFieldToFilter('order_id', $inc_id)
		...
		$html .= '<div class="entry-edit">
					...
					<div class="grid" id="order-items_grid">
						<table cellspacing="0" class="data order-tables">
							...
							<col width="100" />
							<thead>
								<tr style="background-color:#6F8992; text-align:left;"><th colspan="5"><h2 style="color:white;margin-top:10px">
Order Amount(s)
</h2></th></tr>
