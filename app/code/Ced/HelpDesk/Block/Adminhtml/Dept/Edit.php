 ...
 */
namespace Ced\HelpDesk\Block\Adminhtml\Dept;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_controller = 'adminhtml_dept';
    ...
    {
        if ($this->_coreRegistry->registry('ced_department')->getId()) {
            return __("Edit Post '%1'", $this->escapeHtml($this->_coreRegistry->registry('ced_department')->getTitle()));
        } else {
