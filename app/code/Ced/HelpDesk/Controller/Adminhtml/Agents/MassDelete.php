...
use Ced\HelpDesk\Model\ResourceModel\Agent\CollectionFactory;
...
class MassDelete extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        return $this->resultFactory->create(ResultFactory::TYPE_REDIRECT)->setPath('helpdesk/agents/agentsinfo');
    }
}
