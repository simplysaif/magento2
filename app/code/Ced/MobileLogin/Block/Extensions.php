...
namespace Ced\MobileLogin\Block;
/**
...
class Extensions extends \Magento\Config\Block\System\Config\Form\Fieldset  
{
    ...
    public function __construct(
        ...
        $this->_helper = $this->_objectManager->get('Ced\MobileLogin\Helper\Data');
    ...
    public function render(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
		...
		$modules =  $this->_objectManager->get('\Ced\MobileLogin\Helper\Feed')->getAllModules();
    ...
    {
    	$hash = \Ced\MobileLogin\Block\Extensions::HASH_PATH_PREFIX.strtolower($moduleName).'_hash';	
    	$level = \Ced\MobileLogin\Block\Extensions::HASH_PATH_PREFIX.strtolower($moduleName).'_level';

	 	$helper = $this->_objectManager->create('\Ced\MobileLogin\Helper\Data');
		...
		$l = $this->_objectManager->create('\Ced\MobileLogin\Helper\Feed')->getLicenseFromHash($hash,$level);
