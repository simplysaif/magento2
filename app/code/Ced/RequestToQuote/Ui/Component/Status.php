                ...
                if (isset($item['status'])) {
                    switch ($item['status']) {
                        ...
                        case '0':
                            ...
                            break;
                        case '1':
                            $item[$this->getData('name')] = 'Processing';
                            break;
                        case '2':
                            $item[$this->getData('name')] ='Approved';
                            break;
                        case '3':
                            $item[$this->getData('name')] = 'Cancelled';
                            break;
                        case '4':
                            $item[$this->getData('name')] = 'PO Created';
                            break;
                        case '5':
                            $item[$this->getData('name')] = 'Partial PO';
                            break;
                        case '6':
                            $item[$this->getData('name')] = 'Ordered';
                            break;
                        case '7':
                            $item[$this->getData('name')] = 'Complete';
                            break;
