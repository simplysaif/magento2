 ...
 * CedCommerce
  ...
  *
  * @category    Ced
  * @package     Ced_CsProductFilter
  * @author       CedCommerce Core Team <connect@cedcommerce.com >
  * @copyright   Copyright CEDCOMMERCE (http://cedcommerce.com/)
  * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
  */
namespace Ced\TeamMember\Block\Vendor\Chat;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareColumns() {
       ...
       $this->addColumn('view_conversation', [
				...
				'filter'   	 	=> false,
				'type'          => 'text',
				'renderer' => 'Ced\TeamMember\Block\Vendor\Chat\Renderer\Conversation'
			]
		);
		...
		$this->addColumn('send_message', [
				...
				'filter'   	 	=> false,
				'type'          => 'text',
				'renderer' => 'Ced\TeamMember\Block\Vendor\Chat\Renderer\Chat'
			]
		);
