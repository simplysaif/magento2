...
namespace Ced\TeamMember\Controller\Member;
...
class Send extends \Ced\TeamMember\Controller\TeamMember
{
    /**
    ...
    {    
    	...
    	$model->setReceiver('vendor');
    	$model->setReceiverEmail($this->getRequest()->getParam('vendoremail'));
