...
class Version extends \Plumrocket\Base\Block\Adminhtml\System\Config\Form\Version
{
     ...
     * @var string
     */
    protected $_wikiLink = 'http://wiki.plumrocket.com/wiki/Accelerated_Mobile_Pages_Magento_2_Extension_v2.x';
    ...
    {
        return '<script type="text/javascript" src="'. $this->getViewFileUrl('Plumrocket_Amp::js/jscolor/jscolor.js') . '"></script>';
    }
