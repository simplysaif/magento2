...
class Messages extends \Magento\Framework\View\Element\Template
{
    ...
    {
        if ($clear) {
            $this->_clearMessagesCookieVariable();
        }
        return $this->_messages;
    }

    /**
     * Clear cookie messages
     * @return object
     */
    private function _clearMessagesCookieVariable()
    {
        $this->cookieManager->deleteCookie(self::MESSAGES_COOKIES_NAME);
        return $this;
    }
