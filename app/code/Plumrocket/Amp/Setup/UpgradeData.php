...
class UpgradeData implements UpgradeDataInterface
{
    ...
    public function upgrade(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (version_compare($context->getVersion(), '2.1.0', '<')) {
            ...
            $eavSetup->addAttributeToGroup($entityTypeId, $attributeSetId, $attributeGroupId, 'amp_homepage_image', '270');
        }
        ...
        if (version_compare($context->getVersion(), '2.2.3', '<')) {
            ...
            $eavSetup->addAttributeToGroup($entityTypeId, $attributeSetId, $attributeGroupId, 'amp_display_mode', '270');
        }
