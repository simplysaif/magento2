...
var pattern=/(set\/)(\d)*?\//,change='$1'+data.value+'/';window.open(window.location.href.replace(pattern,change),"_self");if(!this.multiple){if(!isSelected){this.value(data.value);}
