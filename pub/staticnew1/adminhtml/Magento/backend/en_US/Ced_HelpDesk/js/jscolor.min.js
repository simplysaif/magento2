...
this.exportColor(jsc.leaveValue|jsc.leaveStyle);}else if(this.fromString(this.valueElement.value)){}else{this.exportColor(2);}}else{this.exportColor();}}};this.exportColor=function(flags){if(flags==2){if(this.styleElement){this.styleElement.style.backgroundImage='none';this.styleElement.style.backgroundColor='transparent';this.styleElement.style.color='#000';}}else{if(!(flags&jsc.leaveValue)&&this.valueElement){var value=this.toString();if(this.uppercase){value=value.toUpperCase();}
