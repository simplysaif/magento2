...
return true;}
Event.observe(window,'load',function(){if($('price_default')&&$('price_default').checked){$('price').disabled='disabled';}});function toggleSeveralValueElements(checkbox,containers,excludedElements,checked){'use strict';if(containers&&checkbox){if(Object.prototype.toString.call(containers)!='[object Array]'){containers=[containers];}
