...
return Component.extend({initialize:function(){this._super();this.banner=Banner.get('data');_.each($('[data-banner-id]'),function(banner){banner=$(banner);this['getItems'+banner.data('banner-id')]=getItems.bind(null,banner);},this);}});});