define(['ko','Magento_Checkout/js/model/quote','Magento_Checkout/js/model/resource-url-manager','mage/storage','Magento_Checkout/js/model/error-processor','Magento_Checkout/js/model/full-screen-loader','Magento_Checkout/js/action/select-billing-address','Magestore_OneStepCheckout/js/model/billing-address-state'],function(ko,quote,resourceUrlManager,storage,errorProcessor,fullScreenLoader,selectBillingAddressAction,BillingAddressState){'use strict';return{saveShippingInformation:function(){var payload;if(!quote.billingAddress()||BillingAddressState.sameAsShipping()==true){selectBillingAddressAction(quote.shippingAddress());}
