...
class Processor
{
     ...
     * Get logging handler
     *
     * @return ControllersLoggingHandler
     * @deprecated 100.2.0
     */
    private function getHandler()
    {
        if ($this->_controllersHandler === null) {
            $this->_controllersHandler = $this->_objectManager->get(ControllersLoggingHandler::class);
        }
        return $this->_controllersHandler;
    }
