...
class BackupDbCommandTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testExecute()
    {
        ...
        $backupCommand = '(nice -n 15  -uroot -hlocalhost --port 3306 -p"abc!123$" magento --skip-extended-insert  customer_entity customer_entity_varchar customer_address_entity customer_address_entity_varchar customer_grid_flat quote quote_address sales_order sales_order_address sales_order_grid |  -r \'while ($line=fgets(STDIN)) {
